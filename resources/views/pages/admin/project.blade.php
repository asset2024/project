                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="position: sticky; right: 0; z-index: 1; background: #fff">
                                    ...
                                    <button type="button" class="btn btn-sm btn-secondary " title="Edit" data-target="#editModal"><i class="fa fa-edit"></i></button>

                                    <a href="detail-project" class="btn btn-sm btn-danger js-sweetalert" title="Detail"><i class="fa fa-search"></i></a>
                                </td>
                            </tr>
                            {{-- modal edit --}}
